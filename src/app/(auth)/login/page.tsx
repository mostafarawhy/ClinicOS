...
export default function LoginPage() {
  ...
  async function handleUseAccount(account: (typeof DEMO_ACCOUNTS)[0]) {
    ...
    // Auto sign in immediately on click
    setLoading(true);
      ...
      <div className="w-full max-w-md space-y-5">
        ...
        <div className="rounded-xl border-2 border-primary/20 bg-primary/5 p-5">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5 leading-relaxed">
                DentaFlow is a real clinic management system built for an Upwork
                client. Select a role below to explore the full app — no sign-up
                needed.
              </p>
            </div>
          </div>
          ...
          <p className="mt-3 text-[11px] text-muted-foreground text-center">
            Clicking a role fills the form below automatically
          </p>
        </div>
