          ...
          appointments.map((appt) => (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <span
                  className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium capitalize shrink-0 ${statusStyles[appt.status] ?? "bg-secondary text-muted-foreground"}`}
                >
                  {appt.status}
                </span>
              </div>
